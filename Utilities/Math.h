...
class Matrix; // Forward declaration pentru Matrix
class Vector4; // Forward declaration pentru Vector4
...
public:
    ...
    // Mutăm constructorul de conversie din Vector4 în fișierul .cpp
...
public:
    ...
    // Mutăm constructorul de conversie din Vector3 în fișierul .cpp
    Vector4(Vector3& vector);
    Vector4(Vector3& vector, GLfloat _w);
